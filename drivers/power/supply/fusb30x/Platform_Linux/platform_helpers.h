...
/*******************************************************************************
* Function:        fusb_InitializeUSBMux
* Input:           none
* Return:          0 on success, error code otherwise
* Description:     Initializes the platform's GPIO to control USBMUX
********************************************************************************/
FSC_S32 fusb_InitializeUSBMux(void);

/*******************************************************************************
* Function:        fusb_GPIO_Set_OTG/VBus5v/Other
* Input:           set: true to set pin, false to clear
* Return:          none
* Description:     Sets or clears the OTG/VBus5V/Other gpio pin
********************************************************************************/
