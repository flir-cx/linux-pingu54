...
#define PD_MaxVoltage_as_Sink 100          //; 5.0V
#define PD_MaxPower_as_Sink 30000          //; 3.0W
#define PD_OpPower_as_Sink 30000           //; 3.0W
...
#define Snk_PDO_Op_Current1 300
...
#define Requests_PR_Swap_As_Src YES
...
#define Product_Type_SOP 2                  /* 2=PD USB peripheral */
#define Modal_Operation_Supported_SOP YES
#define USB_VID_SOP USB_VID_FLIR_SYSTEMS    /* FLIR Systems (USB VendorID) */
#define PID_SOP 0x0000                      /* Dynamic (USB ProductID) */
...
#define SVID1_SOP 0x0000                    /* No SVID's available */
...
#define Type_C_Implements_Try_SRC NO        /* "Src Preferred" */
#define Type_C_Implements_Try_SNK NO        /* "Snk Preferred" */
...
/* FLIR added definitions */
#define USB_VID_FLIR_SYSTEMS		0x09cb
#define USB_PID_FLIR_NETWORK_ADAPTER	0x1001
#define USB_PID_FLIR_EX_RNDIS		0x1002
#define USB_PID_FLIR_EX_UVC		0x1004
#define USB_PID_FLIR_EX_RNDIS_UVC	0x1005
#define USB_PID_FLIR_EX_RNDIS_MSD	0x1006
#define USB_PID_FLIR_EX_UVC_MSD		0x1007
#define USB_PID_FLIR_SERIAL_PORT	0x1008
#define USB_PID_FLIR_ONE_CAMERA		0x1996
#define USB_PID_FLIR_MSD		0xffff

#define VBUS_THRESH_SOURCE_MIN_5V	VBUS_MDAC_4P62
#define VBUS_THRESH_SOURCE_MAX_5V	VBUS_MDAC_5P46   // was 5P04
#define VBUS_THRESH_DETACH_5V		VBUS_MDAC_3P78   // was 4P20
#define VBUS_THRESH_ATTACH_5V		VBUS_MDAC_4P20   // was 4P62
#define VBUS_THRESH_SAFE_SINK		VBUS_MDAC_3P36   // was 0P84
#define VBUS_THRESH_SAFE_0V		VBUS_MDAC_0P84V
