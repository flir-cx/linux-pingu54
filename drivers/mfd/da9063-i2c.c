			    ...
			    const struct i2c_device_id *id)
{
	...
	da9063_regmap_config.reg_bits = 8;
	da9063_regmap_config.pad_bits = 0;
	da9063_range_cfg->selector_mask = 1 << DA9063_I2C_PAGE_SEL_SHIFT;
	da9063_range_cfg->selector_shift = DA9063_I2C_PAGE_SEL_SHIFT;
	da9063_range_cfg->window_len = 256;
